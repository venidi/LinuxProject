...
if __name__ == '__main__':
    model = Model()
    # 加载训练完的模型
    model.load_model(file_path=r'/home/venidi/FaceRecognition/test/LinuxProject/models/faceD_2.model.h5')
    ...
    TIME = 3
    C = 1
    path_name = r'/home/venidi/FaceRecognition/test/LinuxProject/faces/faceD_2'
    num = 0
